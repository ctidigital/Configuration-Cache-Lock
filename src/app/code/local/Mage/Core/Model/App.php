...
class Mage_Core_Model_App
{
    ...
    const XML_PATH_CACHE_LOCK_ENABLE = 'global/cache_lock/enable';
    ...
    */
    ...
    /**
     * If the cache requires a refresh, set a lock in the specified Redis database. Subsequent requests are then
     * retried after a period of time to let the cache regenerate.
     *
     * @return $this
     */
    protected function _initModulesWithLocking ()
    {
        ...
        $ctiCache = new Cti_Cache_Cache();

        // Check if a cache lock has been created
        $cacheLock = false;
        ...
        // The maximum amount of times to recheck the cache is generated
        $maxAttempts = $ctiCache->getMaxAttempts();

        // Current attempts
        $attempts = 0;

        // If the lock is found keep retrying to see if the cache has been generated
